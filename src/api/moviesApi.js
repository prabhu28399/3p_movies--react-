export const apiMovies = async () => {
  return [
    ...
    },
    {
      ...
      language: ["English", "Hindi"],
      genre: ["Action", "Adventure", "Sci-Fi"],
      image: "https://unfspinnaker.com/wp-content/uploads/2019/02/alita.jpg",
      description:
    ...
    },
    {
      ...
      image:
        "https://m.media-amazon.com/images/M/MV5BMTYxNjg4MzU5OV5BMl5BanBnXkFtZTcwOTA3NTUwMw@@._V1_.jpg",
      description:
    ...
    },
    {
      ...
      description: "Download Dune (2021) 720p [1.2GB] || 1080p [3GB]",
    },
  ];
};
